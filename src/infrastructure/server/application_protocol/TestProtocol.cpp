...
namespace webserv {
	namespace appProtocol {
		...
		TestProtocol::PushStatus::Type TestProtocol::pushRequest(const char* inputBuf, const std::size_t size,
		...
		TestProtocol::PushStatus::Type TestProtocol::pushStream(const char* streamBuf, const std::size_t size,
		...
		TestProtocolFactory::TestProtocolFactory(const std::string& body) : m_body(body) {}
